          ...
          <div className="Schedule">
            <main>
              <div className="container">
                <div className="bg-box-top py-3">
                  <h1>Scheduling</h1>
                  <p className="lead">
                    Planning makes your trip more efficient, maximizes time, and
                    minimizes unnecessary stress.
                  </p>
                  <a className="btn btn-outline-light text-white px-2" href="/schedule" role="button">Let's make a plan now &raquo;</a>
                </div>
                <h2 className="pb-2 py-3 border-bottom">Let's plan the perfect trip</h2>
                ...
                <div className="row row-cols-1 row-cols-md-2 align-items-md-center g-5 py-5">
                  ...
                  <div className="col-md-3 col-sm-12">
                    ...
                    <div className="card">
                      <div className="card-header fs-5 fw-semibold py-2  justify-content-between">
                          <span className="text-start">Favorite place</span>
                          <button className="btn dropdown-toggle" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                          </button>
                      </div>
